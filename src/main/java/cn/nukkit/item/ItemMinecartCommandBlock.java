...
public class ItemMinecartCommandBlock extends Item {
    ...
    public ItemMinecartCommandBlock(Integer meta, int count) {
        super(MINECART_WITH_COMMAND_BLOCK, meta, count, "Minecart with Command Block");
    }
    ...
    public boolean onActivate(Level level, Player player, Block block, Block target, BlockFace face, double fx, double fy, double fz) {
        if (Rail.isRailBlock(target)) {
            ...
            EntityMinecartCommandBlock minecart = (EntityMinecartCommandBlock) Entity.createEntity("MinecartCommandBlock",
